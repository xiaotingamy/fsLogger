...
declare namespace my {
   ...
   */
  namespace ix {
    interface IGetSysPropSuccessResult {
      readonly value: string | Readonly<Record<string, any>>
    }
    interface IGetSysPropOptions {
      key: string
      success?(res: IGetSysPropSuccessResult): void
      fail?(): void
    }
    function getSysProp(data: IGetSysPropOptions): void

    function getVersion(data: object): void
  }
}
