...
declare namespace my {
  ...
  function notifyBLECharacteristicValueChange(
    options: INotifyBLECharacteristicValueChangeOptions
  ): void
  ...
  function onBLECharacteristicValueChange(
    callback: (res: IOnBLECharacteristicValueChangeEvent) => void
  ): void
  ...
  function onBLEConnectionStateChanged(
    callback: (res: IOnBLEConnectionStateChangedEvent) => void
  ): void
  ...
  function onBluetoothAdapterStateChange(
    callback: (res: IOnBluetoothAdapterStateChangeEvent) => void
  ): void
